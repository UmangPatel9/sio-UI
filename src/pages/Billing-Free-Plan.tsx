...
import { 
  ...
  const BillingFreePlan: React.FC = () => {
                    ...
                    <IonCol size="12" sizeMd="6" sizeLg="4">
                        ...
                        <IonRow className="main-title-with-icons-on-right">
                            <IonCol size="6" sizeMd="6"  sizeLg="6" className="title-wrap ion-no-padding">
                                <h1 className="ion-no-margin">Free Plan</h1>
                                <h5 className="project-number ion-no-margin"><b>Project</b>: 1</h5>
                            </IonCol>
  ...
  export default BillingFreePlan;